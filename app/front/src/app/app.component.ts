...
export class AppComponent implements OnInit {
  ...
  private refreshState() {
    this.http.get<object>(environment.api_endpoint + "/health").subscribe(
      (res: object) => {
        this.health = res;
  ...
  public searchProducts(query: string = "") {
    ...
    this.http
      .get<object[]>(environment.api_endpoint + "/product?q=" + query)
      .subscribe(
        (products: object[]) => {
  ...
  public createProduct(data: object) {
    ...
    this.http
      .post<object>(environment.api_endpoint + "/product", body)
      .subscribe(
        (product: object) => {
          this.imagePath = "";
          this.formError = "";
  ...
  public removeProduct(id: string) {
    ...
    this.http
      .delete<object>(environment.api_endpoint + "/product/" + id)
      .subscribe(
        () => {
  ...
  public getRandomImagePath() {
    return this.http
      .get<object[]>("https://api.thecatapi.com/v1/images/search?size=full")
      .toPromise()
      .then((data: object) => {
