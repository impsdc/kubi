...
# # ELS
# kubectl  apply -f els/config.yml
# # helm install els elastic/elasticsearch -f ./els/values.yml
# # helm install els  oci://registry-1.docker.io/bitnamicharts/elasticsearch --values els/values.yml
# # helm install els romanow/elasticsearch 
